<template>
  <div class="wrapper" ref="myscroll">
    <!-- 商品列表 start -->
    <ul class="messageList bgeeeeee" v-if="messageList.length">
      <!-- 商品简介 start -->
      <li v-for="(item, index) in messageList" :key="index">
        <router-link :to="{name: 'messagedetail', params: {id: item.id}}" tag="div" class="message_item bgffffff">
...
<style scoped>
@import 'static/css/myscrollMessage.css';
